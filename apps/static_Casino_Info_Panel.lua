...
local howToPlay = [[
&aКак играть?
 &f1. Встаньте на плиту(PIM) и выберите игру.
 2. Возьмите в инвентарь необходимое количество валюты и играйте.
 &cБудьте внимательны и проверяйте чтоб в казино было достаточно валюты!
...
&aК кому обращаться с вопросами?
 &f1. M4_touchpad &3Discord: &bIvan.K#0197
 &f2. memdess  &3Discord: &bmemdess#7680
...
&aПомните:
 &f1. В казино может повезти или нет
 &f2. Все зависит от твоей удачи
